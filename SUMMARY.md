...
* [Configuration](set-up/untitled.md)
* [Currency](set-up/untitled-1-1.md)
* [Custom fields](set-up/untitled-1.md)
...
* [Where can i find my sub-template](where-can-i-find-my-sub-template.md)
...
* [Variable product](variable-product.md)
* [Flexible variable product](flexible-variable-product.md)
* [Downloadable product](downloadable-product.md)
* [Assigning a product to multiple categories](assigning-a-product-to-multiple-categories.md)
* [Options](options.md)
* [Import product options](import-product-options.md)
* [Product filters](product-filters.md)
...
* [Adding specifications to your products](adding-specifications-to-your-products.md)
* [Adding related products](adding-related-products.md)
* [Ordering products on your storefront](ordering-products-on-your-storefront.md)
