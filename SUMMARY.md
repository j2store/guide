...
* [Troubleshooting Guide](troubleshooting-guide/README.md)
  * [Frequently Asked Questions](troubleshooting-guide/frequently-asked-questions/README.md)
    * [Where can i find my sub-template](troubleshooting-guide/frequently-asked-questions/where-can-i-find-my-sub-template.md)
    * [Products not aligned properly on list view](troubleshooting-guide/frequently-asked-questions/products-are-not-aligned-properly-on-list-view.md)
    * [SCA support for payment plugins](troubleshooting-guide/frequently-asked-questions/sca-support-for-payment-plugins.md)
    * [To show the base price instead of price range in flexivariable products](troubleshooting-guide/frequently-asked-questions/to-show-the-base-price-instead-of-price-range-in-flexivariable-products.md)
    * [Where do I add the CSS on my site](troubleshooting-guide/frequently-asked-questions/where-do-i-add-the-css-on-my-site.md)
    * [Unable to save the settings in any app](troubleshooting-guide/frequently-asked-questions/not-able-to-save-the-settings-in-any-app.md)
    * [Difference between product types](troubleshooting-guide/frequently-asked-questions/difference-between-product-types.md)
    * [Commonly found issues](troubleshooting-guide/frequently-asked-questions/commonly-found-issues.md)
    * [Frequently Asked Questions](troubleshooting-guide/frequently-asked-questions/frequently-asked-questions.md)
    * [Quantity Restriction](troubleshooting-guide/frequently-asked-questions/quantity-restriction.md)
